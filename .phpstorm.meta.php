...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/html/public/storage','horizon.domain',
...
'horizon.environments.local.supervisor-1.maxProcesses','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'hashing.argon.time','hashing.argon.verify','hashing.rehash_on_login','concurrency.default','one-time-operations.directory',
'one-time-operations.table','one-time-operations.connection','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'horizon.jobs.show','horizon.index','sanctum.csrf-cookie','telescope','storage.local',);
        registerArgumentsSet('views', 
'errors.401','errors.402','errors.403','errors.404','errors.419',
'errors.429','errors.500','errors.503','errors.layout','errors.minimal',
'spa','horizon::layout','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'APP_DOMAIN','APP_URL','SANCTUM_STATEFUL_DOMAINS','APP_LOCALE','APP_FALLBACK_LOCALE',
'APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER','APP_MAINTENANCE_STORE','HASH_DRIVER','PHP_CLI_SERVER_WORKERS',
...
'AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET','AWS_ENDPOINT','AWS_USE_PATH_STYLE_ENDPOINT',
'AWS_URL','VITE_APP_NAME','TELESCOPE_ENABLED','VIEW_COMPILED_PATH','XDEBUG_SESSION',
'XDEBUG_CONFIG',);
